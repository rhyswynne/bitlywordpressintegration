...
/**
* @file
* bit.ly API integration for WordPress.
* Based on the Simple PHP Library by Kevin Marshall <info@falicon.com> & Robin Monks <devlinks@gmail.com>
* Uses wp_remote_get and wp_remote_post (to-do), which works better on cURL based systems.
*
...
/**
* Make a wp_remote_get call to the bit.ly API. Returns the response or a WP_Error on failure.
*
* @param $uri
* URI to call.
*/
